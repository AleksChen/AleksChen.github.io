...
const UI_TEXT = {
  zh: {
    ...
    home: {
      description:
        "AleksChen 的技术笔记，记录全栈工程、AI Builder 与增长工程实践。",
      intro: "全栈工程师 / AI Builder",
      lead:
        "把前端体验、后端服务、AI 工作流和增长实验落到真实产品里。这里优先沉淀可复用的实现笔记、源码解析和工程判断。",
      latest: "最新文章",
    ...
    about: {
      title: "关于 AleksChen",
      description:
        "我关注如何把全栈工程能力、AI 能力和增长目标合在一起，做出能持续迭代的产品系统。",
      introTitle: "我在做什么",
      intro:
        "我是 AleksChen，首先是一名全栈工程师，关注从前端体验、后端服务到工程化交付的完整链路；同时也是 AI Builder，持续把 AI 编程、Agent 工作流和人机协作落到真实项目、工具与自动化流程里。",
      buildTitle: "构建方向",
      buildItems: [
        "AI 辅助产品与自动化工作流",
        "增长实验、数据反馈和转化路径优化",
    ...
    seo: {
      siteDescription:
        "Aleks 的技术博客，专注 Web 全栈工程、AI Builder 实践、跨端开发与网络技术。",
    },
  },
  en: {
    actions: {
    ...
    home: {
      description:
        "AleksChen's technical notes on full-stack engineering, AI building, and growth engineering.",
      intro: "Full-stack Engineer / AI Builder",
      lead:
        "I turn frontend experience, backend services, AI workflows, and growth experiments into practical products. This site prioritizes reusable implementation notes, source-code reading, and engineering judgment.",
    ...
    about: {
      ...
      description:
        "I focus on combining full-stack engineering, AI capability, and growth goals into product systems that can keep improving.",
      introTitle: "What I Do",
      intro:
        "I'm AleksChen, first a full-stack engineer focused on the complete delivery path from frontend experience and backend services to reliable engineering systems. I am also an AI Builder, turning AI coding, agent workflows, and human-AI collaboration into practical projects, tools, and automation.",
    ...
    seo: {
      siteDescription:
        "Aleks's technical blog focused on full-stack web engineering, AI Builder workflows, cross-platform development, and networking.",
    },
  },
} as const;
