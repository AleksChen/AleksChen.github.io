...
const frontmatter = {
  ...
  "seoDescription": "系统梳理 Vue3 编译宏的使用方式与底层原理，涵盖 defineProps、defineEmits、withDefaults、defineModel 等常见宏及编译阶段行为。",
  "seoKeywords": ["Vue3", "编译宏", "defineProps", "defineEmits", "withDefaults", "defineModel", "script setup"]
};
