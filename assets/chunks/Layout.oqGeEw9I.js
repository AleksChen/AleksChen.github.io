import { c as createComponent, m as maybeRenderHead, d as addAttribute, a as renderTemplate, b as createAstro, u as unescapeHTML, e as renderScript, r as renderComponent, f as renderSlot, g as renderHead } from './astro/server.Bhkeg0Hl.js';
import 'piccolore';
/* empty css                        */
import 'clsx';
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer class="mt-8 flex justify-center"> <small class="w-full max-w-[720px] min-h-12 flex justify-center items-center opacity-80"> <a${addAttribute(config.footer.copyrightUrl, "href")} target="_blank">${`\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} ${config.footer.copyright}`}</a> </small> </footer>`;
