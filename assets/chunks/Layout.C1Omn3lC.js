...
const $$PageLoader = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="page-loader" aria-hidden="true" data-astro-cid-yztiywgj> <div class="loader-inner" data-astro-cid-yztiywgj> <div class="loader-text" data-astro-cid-yztiywgj> <span data-astro-cid-yztiywgj>L</span><span data-astro-cid-yztiywgj>O</span><span data-astro-cid-yztiywgj>A</span><span data-astro-cid-yztiywgj>D</span><span data-astro-cid-yztiywgj>I</span><span data-astro-cid-yztiywgj>N</span><span data-astro-cid-yztiywgj>G</span> </div> <div class="loader-bar" data-astro-cid-yztiywgj> <div class="loader-bar-fill" data-astro-cid-yztiywgj></div> </div> </div> </div>  ${renderScript($$result, "/home/runner/work/AleksChen.github.io/AleksChen.github.io/src/components/PageLoader.astro?astro&type=script&index=0&lang.ts")}`;
